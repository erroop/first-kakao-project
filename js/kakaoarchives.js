$(function(){
    ...
    const list = $(".kakao_archives_list ul li")
    const list_btn_color = (first, second, third, four ,five, six) => {
        list.removeClass("on")
    ...
    list.eq(0).click(function(){
        list_btn_color("on", "out", "out", "out", "out", "out")
    })
    list.eq(1).click(function(){
        list_btn_color("out", "on", "out", "out", "out", "out")
    })
    list.eq(2).click(function(){
        list_btn_color("out", "out", "on", "out", "out", "out")
    })
    list.eq(3).click(function(){
        list_btn_color("out", "out", "out", "on", "out", "out")
    })
    list.eq(4).click(function(){
        list_btn_color("out", "out", "out", "out", "on", "out")
    })
    list.eq(5).click(function(){
        list_btn_color("out", "out", "out", "out", "out", "on")
    })
})